...
// Use WHATWG URL API for IDN domain validation (replaces deprecated punycode module)
...
// Use WHATWG URL API (replaces deprecated url.parse)
...
// Use Buffer.from() (replaces deprecated Buffer constructor)
